...
#ifndef _HARDWARE_CONFIG_AT89C51ED2_ER_PRO_LED_H
#define _HARDWARE_CONFIG_AT89C51ED2_ER_PRO_LED_H
...
/** @brief Device Option : use HT1632 Display Driver IC for ER PLUS - M LED*/
#define DISP_DRV_HT1632_ER_LED
...
/** @brief LED_PIN_STATE*/
/** @brief LED Chip select*/
sbit LED_CS = P2^3;
/** @brief LED Write signal*/
sbit LED_WR = P2^2;
