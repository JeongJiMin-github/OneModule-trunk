...
* @brief   Hardware Configuraiton Header File\n
           for OMV4 ER JR LCD
* @file    HardwareConfig_M0516ldn_Er2_Lcd.h
* @version 1.0
* @date    2016/12/06
...
#ifndef _HARDWARE_CONFIG_M0516LDN_ER2_LCD_H
#define _HARDWARE_CONFIG_M0516LDN_ER2_LCD_H
...
/** @brief Device Option : use ER JR LCD Key Driver */
...
#endif //_HARDWARE_CONFIG_M0516LDN_ER2_LCD_H