...
* @brief   Hardware Configuraiton Header File\n
           for OMV4 ER JR LCD (Dry Battery)
* @file    HardwareConfig_M0516ldn_Er2_Lcd_Dry_Batt.h
* @version 1.0
* @date    2016/12/06
...
#ifndef _HARDWARE_CONFIG_M0516LDN_ER2_LCD_DRYBATT_H
#define _HARDWARE_CONFIG_M0516LDN_ER2_LCD_DRYBATT_H
...
#define DISP_DRV_HT1622_M0516LDN_ER2
...
/** @brief Device Option : use ER2 Key Driver */
#define KEY_DRV_OMV4_ER2_LCD
...
#define BATT_TYPE_DRY_6V_PB_6V_WITH_CHECK_VOLT
...
#endif //_HARDWARE_CONFIG_M0516LDN_ER2_LCD_DRYBATT_H