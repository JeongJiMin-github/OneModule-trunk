...
#ifndef _HARDWARE_CONFIG_AT89C51ED2_DB2_LCD_H
#define _HARDWARE_CONFIG_AT89C51ED2_DB2_LCD_H
...
/** @brief LEDBAR_PIN_STATE */
/** @brief LEDBAR Data signal*/
sbit LEDBAR_DATA	=	P0^4;
/** @brief LEDBAR clock*/
sbit LEDBAR_CLK		=	P0^5;
/** @brief LEDBAR latch signal*/
sbit LEDBAR_LATCH	=	P0^6;
