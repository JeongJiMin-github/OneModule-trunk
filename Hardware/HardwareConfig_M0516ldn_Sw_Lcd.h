...
* @brief   Hardware Configuraiton Header File\n
           for OMV4 SW LCD
* @file    HardwareConfig_M0516ldn_Sw_Lcd.h
* @version 1.0
* @date    2016/12/06
...
#ifndef _HARDWARE_CONFIG_M0516LDN_SW_LCD_H
#define _HARDWARE_CONFIG_M0516LDN_SW_LCD_H
...
#define DISP_DRV_HT1621_M0516LDN
...
/* - display module*/
#define HT1621_CS       P00
#define HT1621_CS_HIGH  {HT1621_CS = 1;}
#define HT1621_CS_LOW   {HT1621_CS = 0;}

#define HT1621_WR       P01
#define HT1621_WR_HIGH  {HT1621_WR = 1;}
#define HT1621_WR_LOW   {HT1621_WR = 0;}

#define HT1621_SDA_DATA     P02
#define HT1621_SDA_HIGH	    {HT1621_SDA_DATA = 1;}
#define HT1621_SDA_LOW      {HT1621_SDA_DATA = 0;}
#define HT1621_SDA_INCHANGE     {GPIO_SetMode(P0, BIT2, GPIO_PMD_INPUT);}
#define HT1621_SDA_OUTCHANGE    {GPIO_SetMode(P0, BIT2, GPIO_PMD_OUTPUT);}
...
#endif //_HARDWARE_CONFIG_M0516LDN_SW_LCD_H
