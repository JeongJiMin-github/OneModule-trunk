...
* @file    HardwareConfig_M0516ldn_Er_Plus_Lcd.h
* @version 1.0
* @date    2016/12/06
...
#ifndef _HARDWARE_CONFIG_M0516LDN_ER_PLUS_LCD_H
#define _HARDWARE_CONFIG_M0516LDN_ER_PLUS_LCD_H
...
#define DISP_DRV_HT1622_M0516LDN_ER_PRO
...
#define KEY_DRV_OMV4_ER_PRO_LCD 
...
#define KEY_IN_PORT_REMAIN1     P20
#define KEY_IN_PORT_REMAIN2     P07


/* - display module*/
#define HT1622_CS       P23
#define HT1622_CS_HIGH  {HT1622_CS = 1;}
#define HT1622_CS_LOW   {HT1622_CS = 0;}

#define HT1622_WR       P22
#define HT1622_WR_HIGH  {HT1622_WR = 1;}
#define HT1622_WR_LOW   {HT1622_WR = 0;}

#define HT1622_SDA_DATA     P21
#define HT1622_SDA_HIGH	    {HT1622_SDA_DATA = 1;}
#define HT1622_SDA_LOW      {HT1622_SDA_DATA = 0;}
#define HT1622_SDA_INCHANGE     {GPIO_SetMode(P1, BIT5, GPIO_PMD_INPUT);}
#define HT1622_SDA_OUTCHANGE    {GPIO_SetMode(P1, BIT5, GPIO_PMD_OUTPUT);}
