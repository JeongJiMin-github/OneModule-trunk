...
#ifndef _HARDWARE_CONFIG_AT89C51ED2_ED_LCD_H
#define _HARDWARE_CONFIG_AT89C51ED2_ED_LCD_H
...
/** @brief KEY_PORT */
/** @brief KEY_PORT_POS0*/
sbit KEY_PORT_POS0 = P3^5;
/** @brief KEY_PORT_POS1*/
sbit KEY_PORT_POS1 = P3^4;
/** @brief KEY_PORT_POS2*/
sbit KEY_PORT_POS2 = P3^2;

/** @brief KEY_PORT_POS3*/
sbit KEY_PORT_POS3 = P3^6;
/** @brief KEY_PORT_POS4*/
sbit KEY_PORT_POS4 = P3^3;
/** @brief KEY_PORT_POS5*/
sbit KEY_PORT_POS5 = P2^1;

/** @brief KEY_PORT_POS6*/
sbit KEY_PORT_POS6 = P2^0;
/** @brief KEY_PORT_POS7*/
sbit KEY_PORT_POS7 = P3^7;
