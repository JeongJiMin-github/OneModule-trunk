...
* @brief   Hardware Configuraiton Header File\n
           for FB1H VFD
* @file    HardwareConfig_At89c51ed2_Sw_Lcd.h
* @version 1.0
* @date    2007/04/26
...
#ifndef _HARDWARE_CONFIG_AT89C51ED2_DB1H_VFD_H
#define _HARDWARE_CONFIG_AT89C51ED2_DB1H_VFD_H
...
#define DISP_DRV_PT6311_DB1H_VFD
...
/** @brief KEY_PORT */
/** @brief KEY_PORT_TARE*/
sbit KEY_PORT_TARE = P3^3;//P2^1;
/** @brief KEY_PORT_ZERO*/
sbit KEY_PORT_ZERO = P3^2;//P2^2;
/** @brief KEY_PORT_HOLD*/
sbit KEY_PORT_HOLD = P3^4;//P3^7;
