...
* @file    HardwareConfig_M0516ldn_Er_Plus_Led.h
* @version 1.0
* @date    2016/12/06
...
#ifndef _HARDWARE_CONFIG_M0516LDN_ER_PLUS_LED_H
#define _HARDWARE_CONFIG_M0516LDN_ER_PLUS_LED_H
...
#define DISP_DRV_HT1632_M0516LDN_ER_LED
...
/** @brief Device Option : use ER PLUS - M(LCD) Key Driver */
#define KEY_DRV_OMV4_ER_PRO_LED
...
/* - display module*/
#define LED_CS       P23
#define HT1622_CS_HIGH  {LED_CS = 1;}
#define HT1622_CS_LOW   {LED_CS = 0;}

#define LED_WR       P22
#define HT1622_WR_HIGH  {LED_WR = 1;}
#define HT1622_WR_LOW   {LED_WR = 0;}

#define LED_DATA     P21
#define HT1622_SDA_HIGH	    {LED_DATA = 1;}
#define HT1622_SDA_LOW      {LED_DATA = 0;}
...
#endif //_HARDWARE_CONFIG_M0516LDN_ER_PLUS_LED_H