...
#ifndef _HARDWARE_CONFIG_AT89C51ED2_AD_VFD_H
#define _HARDWARE_CONFIG_AT89C51ED2_AD_VFD_H
...
/** @brief Device Option : use UPD16310 Display Driver IC for AD VFD */
#define DISP_DRV_UPD16310_AD_VFD
...
/** @brief Device Option : use AD VFD Key Driver */
#define KEY_DRV_AD_VFD
...
/** @brief KEY_STATE*/
//sbit KEY_PORT_TARE = P0^1;
/** @brief KEY_PORT_ZERO*/
//sbit KEY_PORT_ZERO = P0^0;
/** @brief KEY_PORT_MODE_HOLD*/
//sbit KEY_PORT_MODE_HOLD = P0^2;

/** @brief KEY_PORT_ZERO*/
sbit KEY_PORT_ZERO = P1^7;
/** @brief KEY_STATE*/
sbit KEY_PORT_TARE = P3^6;
/** @brief KEY_PORT_MODE_HOLD*/
