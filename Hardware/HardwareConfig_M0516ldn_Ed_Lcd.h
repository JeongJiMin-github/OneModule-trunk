...
* @brief   Hardware Configuraiton Header File\n
           for ED LCD
* @file    HardwareConfig_M0516ldn_Ed_Lcd.h
* @version 1.0
* @date    2017/04/25
* @author  Park Young Min (FDC954)
********************************************************************************
* @remark  [Version History]\n
*          v1.0 2017/04/25 created by FDC954 \n
********************************************************************************
*/

#ifndef _HARDWARE_CONFIG_M0516LDN_ED_LCD_H
#define _HARDWARE_CONFIG_M0516LDN_ED_LCD_H
...
/** @brief Device Option : use ED Key Driver */
#define KEY_DRV_OMV4_ED_LCD
...
/* - key module*/
#define SW_CAL                      P10
#define KEY_PORT_POS0               P35
#define KEY_PORT_POS1               P34
#define KEY_PORT_POS2               P32
#define KEY_PORT_POS3               P36
#define KEY_PORT_POS4               P33
#define KEY_PORT_POS5               P21
#define KEY_PORT_POS6               P20
#define KEY_PORT_POS7               P37
...
#endif //_HARDWARE_CONFIG_M0516LDN_ED_LCD_H