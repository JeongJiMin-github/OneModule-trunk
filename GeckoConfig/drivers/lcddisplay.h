...
/**************************************************************************//**
 * @brief Working instance of LCD display  FW
 *****************************************************************************/

/* ½ºÆå»ó ¸ÅÄª */
#define FWSPECDISPLAY
#ifdef FWSPECDISPLAY
MCU_DISPLAY FWDisplay = {
  .Text        = {
    { /* 1 */
      .com[0] = 0, .com[1] = 1, .com[2] = 2, .com[3] = 3,
      .bit[0] = 14, .bit[1] = 14, .bit[2] = 14, .bit[3] = 15,

      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 15, .bit[5] = 15, .bit[6] = 15, .bit[7] = 10,
    ...
    { /* 2 */
      .com[0] = 0, .com[1] = 1, .com[2] = 2, .com[3] = 3,
      .bit[0] = 11, .bit[1] = 11, .bit[2] = 11, .bit[3] = 12,

      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 12, .bit[5] = 12, .bit[6] = 12, .bit[7] = 14,
    ...
    { /* 3 */
      ...
      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 9, .bit[5] = 9, .bit[6] = 9, .bit[7] = 14,
    ...
    { /* 4 */
      .com[0] = 0, .com[1] = 1, .com[2] = 2, .com[3] = 3,
      .bit[0] = 5, .bit[1] = 5, .bit[2] = 5, .bit[3] = 6,

      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 6, .bit[5] = 6, .bit[6] = 6, .bit[7] = 14,
    ...
    { /* 5 */
      .com[0] = 0, .com[1] = 1, .com[2] = 2, .com[3] = 3,
      .bit[0] = 2, .bit[1] = 2, .bit[2] = 2, .bit[3] = 3,

      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 3, .bit[5] = 3, .bit[6] = 3, .bit[7] = 14,
...
MCU_DISPLAY FWDisplay = {
  .Text        = {
    { /* 1 */
      .com[0] = 0, .com[1] = 1, .com[2] = 2, .com[3] = 3,
      .bit[0] = 3, .bit[1] = 3, .bit[2] = 3, .bit[3] = 2,

      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 2, .bit[5] = 2, .bit[6] = 2, .bit[7] = 10,
    ...
    { /* 2 */
      .com[0] = 0, .com[1] = 1, .com[2] = 2, .com[3] = 3,
      .bit[0] = 6, .bit[1] = 6, .bit[2] = 6, .bit[3] = 5,

      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 5, .bit[5] = 5, .bit[6] = 5, .bit[7] = 14,
    ...
    { /* 3 */
      .com[0] = 0, .com[1] = 1, .com[2] = 2, .com[3] = 3,
      .bit[0] = 9, .bit[1] = 9, .bit[2] = 9, .bit[3] = 8,

      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 8, .bit[5] = 8, .bit[6] = 8, .bit[7] = 14,
    ...
    { /* 4 */
      .com[0] = 0, .com[1] = 1, .com[2] = 2, .com[3] = 3,
      .bit[0] = 12, .bit[1] = 12, .bit[2] = 12, .bit[3] = 11,

      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 11, .bit[5] = 11, .bit[6] = 11, .bit[7] = 14,
    ...
    { /* 5 */
      .com[0] = 0, .com[1] = 1, .com[2] = 2, .com[3] = 3,
      .bit[0] = 15, .bit[1] = 15, .bit[2] = 15, .bit[3] = 14,

      .com[4] = 2, .com[5] = 0, .com[6] = 1, .com[7] = 2,
      .bit[4] = 14, .bit[5] = 14, .bit[6] = 14, .bit[7] = 14,
