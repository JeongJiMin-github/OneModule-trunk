...
/** @brief KR : Battery Low Voltage Check Threshold(단위 : %)\n
*		  US :\n
*		  CN :									*/
...
//#ifdef USE_BATT_FULL_SIGN
	if (BattDrvReadVolt() < BATT_FULL_VOLTAGE_IN_CHARGE) 
	{
		BAT_CHG=0;
		return 1;
	}
...
//#endif
//	if (BattDrvGetUseablePercent() < BATT_LOW_THRESHOLD) 
//	{
//		return 1;
//	}
//	else
...
#endif//#ifdef BATT_DRV_CS5550_ER_MLED
