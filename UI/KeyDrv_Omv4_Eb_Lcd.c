...
/* Insert #define here */
/** @brief key 개수 */
#define KEY_DRV_MAX_KEY_NUM	48
/** @brief key ring buffer size */
#define KEY_DRV_BUF_SIZE	5
/** @brief 입력 Pin 개수 */
#define KEY_DRV_IN_PIN_NUM	 6
/** @brief 출력 Pin 개수 */
...
static const INT8U code KeyDrvConvTable[KEY_DRV_MAX_KEY_NUM] = //for RB
{
...
/** @brief raw key(키 위치 번호)를 key function code로 변환하는 table의 default 값, 목업용 키 패드*/

const KEY_TYPE code KeyDrvDefaultFuncTable[1][KEY_DRV_MAX_KEY_NUM] = 
{
	{		
		KEY_X,				KEY_PLU_CALL,	KEY_PLU_SAVE,		KEY_NUM_9,		KEY_NUM_8,  		KEY_NUM_7,
		KEY_SUM,			KEY_ADD,		KEY_CANCEL,			KEY_NUM_6,		KEY_NUM_5,		KEY_NUM_4,
		KEY_NO_FUNC,		KEY_BAT_CHECK,	KEY_BACK_LIGHT,		KEY_NUM_3,		KEY_NUM_2,		KEY_NUM_1,
		KEY_NOT_PRESSED,	KEY_TARE,		KEY_ZERO,  			KEY_C,			KEY_NUM_00,		KEY_NUM_0,

		KEY_PLU_6,			KEY_PLU_5,		KEY_PLU_4,			KEY_PLU_3,		KEY_PLU_2,		KEY_PLU_1,
		KEY_PLU_12,			KEY_PLU_11,		KEY_PLU_10,			KEY_PLU_9,		KEY_PLU_8,		KEY_PLU_7,
		KEY_PLU_18,			KEY_PLU_17,		KEY_PLU_16,			KEY_PLU_15,		KEY_PLU_14,		KEY_PLU_13,
		KEY_PLU_24,			KEY_PLU_23,		KEY_PLU_22,			KEY_PLU_21,		KEY_PLU_20,		KEY_PLU_19,
	}
};
...
/*	for (i = 0; i < KEY_DRV_MAX_KEY_NUM; i++) //csh 20120727
	...
	if ((keyModelNum & 0xFFF0) != MODEL_OMV4_EB_LCD)
	{
		error = 1;
	}
...
#endif//#ifdef KEY_DRV_OMV4_EB_LCD
