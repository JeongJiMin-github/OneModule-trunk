...
* @version 1.0
* @date    2007/04/26
* @author  KI HO Kang (KKH)
********************************************************************************
* @remark  [Version History]\n
*          v1.0 2006/10/02 created by KKH \n
********************************************************************************
*/
...
{
	{
		KEY_ZERO,	KEY_TARE,	KEY_PRINT, 	KEY_ON_OFF, KEY_NOT_EXISTED
	}
};*/
...
/*const KEY_TYPE code KeyDrvFuncTableForPgm[KEY_MAX_KEY_NUM_FOR_PGM] = 
{
	KEY_ZERO,	KEY_NOT_EXISTED,	KEY_TARE,	KEY_PRINT,	KEY_PRINT,	KEY_TARE, KEY_NOT_EXISTED, KEY_NOT_EXISTED, KEY_NOT_EXISTED
};
#endif*/

/** @brief raw key(키 위치 번호)를 key function code로 변환하는 table */
const KEY_TYPE code KeyDrvDefaultFuncTable[2][1][KEY_DRV_MAX_KEY_NUM] =
{
	{
		KEY_ZERO, KEY_TARE,	KEY_HOLD, KEY_ON_OFF, KEY_DUMMY
	},
	{
		KEY_ZERO, KEY_TARE,	KEY_PRINT, KEY_ON_OFF, KEY_DUMMY
	}
};
/**
* @brief menu mode에서 사용할 key func code 
* @remark Enter, C, MenuUp, MenuDown, INCrease, ROTate 순서임 (see KEY_MENU_ENTER_NUM~)
*/
const KEY_TYPE code KeyDrvFuncTableForPgm[2][KEY_MAX_KEY_NUM_FOR_PGM] = 
{
	{
