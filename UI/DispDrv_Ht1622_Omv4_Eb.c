...
#ifdef DISP_DRV_HT1622_M0516LDN_EB
...
#define DISP_DRV_ADDR_CTS_DELAY			{24, 0x10}
#endif
...
void DispDrvSetDecPoint(INT8U winNum, INT8U decPos, INT8U decType, INT8U useThousandPt)
{
	...
	if (decPos == 0xFE) // version string for certi
	{
...
#endif//#ifdef DISP_DRV_HT1622_M0516LDN_EB
