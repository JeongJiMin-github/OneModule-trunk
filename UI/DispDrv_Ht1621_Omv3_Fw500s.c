...
#ifdef DISP_DRV_HT1621_FW500_OMV3
#include "efm32_cmu.h"
/*
********************************************************************************
...
/** @brief OK indicator, for counting*/
#define DISP_DRV_ADDR_CTS				{0, 0x01}
...
/** @brief FONT_0*/
#define REAR_FONT_0	0x7d
/** @brief FONT_1*/
#define REAR_FONT_1	0x60
/** @brief FONT_2*/
#define REAR_FONT_2	0x3e
/** @brief FONT_3*/
#define REAR_FONT_3	0x7a
/** @brief FONT_4*/
#define REAR_FONT_4	0x63
/** @brief FONT_5*/
#define REAR_FONT_5	0x5b
/** @brief FONT_6*/
#define REAR_FONT_6	0x5f
/** @brief FONT_7*/
#define REAR_FONT_7	0x71
/** @brief FONT_8*/
...
/** @brief FONT_@, not exist*/
#define REAR_FONT_ASC64	0x00

//--------- Alphabet ------------------
/** @brief FONT_A*/
#define REAR_FONT_A   0x77
/** @brief FONT_B*/
#define REAR_FONT_B   0x4f
/** @brief FONT_C*/
#define REAR_FONT_C   0x1d
/** @brief FONT_D*/
#define REAR_FONT_D   0x6e
/** @brief FONT_E*/
#define REAR_FONT_E   0x1f
/** @brief FONT_F*/
#define REAR_FONT_F   0x17
/** @brief FONT_G*/
#define REAR_FONT_G   0x5d
/** @brief FONT_H*/
#define REAR_FONT_H   0x67
/** @brief FONT_I*/
#define REAR_FONT_I   0x60
/** @brief FONT_J*/
#define REAR_FONT_J   0x68
/** @brief FONT_K*/
#define REAR_FONT_K   0x07
/** @brief FONT_L*/
#define REAR_FONT_L   0x0d
/** @brief FONT_M*/
#define REAR_FONT_M   0x56
/** @brief FONT_N*/
#define REAR_FONT_N   0x46
/** @brief FONT_O*/
#define REAR_FONT_O   0x4e
/** @brief FONT_P*/
#define REAR_FONT_P   0x37
/** @brief FONT_Q*/
#define REAR_FONT_Q   0x73
/** @brief FONT_R*/
#define REAR_FONT_R   0x06
/** @brief FONT_S*/
#define REAR_FONT_S   0x5b
/** @brief FONT_T*/
#define REAR_FONT_T   0x0f
/** @brief FONT_U*/
#define REAR_FONT_U   0x6d
/** @brief FONT_V*/
#define REAR_FONT_V   0x4c
/** @brief FONT_W*/
#define REAR_FONT_W   0x5c
/** @brief FONT_X*/
#define REAR_FONT_X   0x1a
/** @brief FONT_Y*/
#define REAR_FONT_Y   0x6b
/** @brief FONT_Z*/
#define REAR_FONT_Z   0x3e
