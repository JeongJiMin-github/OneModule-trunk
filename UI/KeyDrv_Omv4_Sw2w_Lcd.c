...
{
    while (!POWER_KEY_CHK);	//wait Pwr key off
...
{  
	...
	else if (!POWER_KEY_CHK)
	{
		keyDrvRawData = 3;
	}
	else if (!KEY_PORT_MODE_HOLD)
	{
		keyDrvRawData = 2;
	}	
	else
...
#endif//#ifdef KEY_DRV_OMV4_SW2W_LCD
