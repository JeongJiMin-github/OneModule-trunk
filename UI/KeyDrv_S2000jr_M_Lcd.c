...
{
	{
		KEY_PLU_4, KEY_PLU_5, KEY_PLU_6, KEY_PLU_7, KEY_PLU_8, KEY_PLU_9, KEY_PLU_10,KEY_PLU_11,KEY_PLU_12, //9		,		
		KEY_PLU_13,KEY_PLU_14,KEY_PLU_15,KEY_PLU_16,KEY_PLU_17,KEY_PLU_18,KEY_PLU_19,KEY_PLU_20,KEY_PLU_21, //18
		KEY_PLU_22,KEY_PLU_23,KEY_PLU_24,KEY_PLU_25,KEY_PLU_26,KEY_PLU_27,KEY_PLU_28,KEY_PLU_29,KEY_PLU_30, //27
		KEY_PLU_31,KEY_PLU_32,KEY_PLU_33,KEY_PLU_34,KEY_PLU_35,KEY_PLU_36,KEY_PLU_37,KEY_PLU_38,KEY_PLU_39, //36
		
		KEY_PLU_1,		KEY_PLU_2,		KEY_PLU_3,		KEY_PLU_SAVE,	KEY_PLU_CALL,
		KEY_NUM_7,		KEY_NUM_8,		KEY_NUM_9,		KEY_BOTH_SAVE,	KEY_UNIT_CHANGE,
		KEY_NUM_4,		KEY_NUM_5,		KEY_NUM_6,		KEY_HALF,		KEY_QUARTER,
		KEY_NUM_1,		KEY_NUM_2,		KEY_NUM_3,		KEY_C,			KEY_SUM,
		KEY_NUM_0,		KEY_NUM_00,		KEY_ZERO,		KEY_TARE,		KEY_ON_OFF,
...
{
	{
		...
		KEY_NUM_1,	KEY_NUM_2,	KEY_NUM_3,	KEY_BAT_CHECK,	KEY_BACK_LIGHT,	//55
...
/*	for (i = 0; i < KEY_DRV_MAX_KEY_NUM; i++) //csh 20120730
	...
	if (keyModelNum != MODEL_S2000JR_M_LCD)
	{
		error = 1;
	}
