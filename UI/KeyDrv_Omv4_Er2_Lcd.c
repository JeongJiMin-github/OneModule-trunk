...
/*#ifdef	USE_DECIMAL_POINT	
	...
	if ((keyModelNum != MODEL_ER2_LCD) && (keyModelNum != MODEL_ER2_LCD_ECR)&&(keyModelNum != MODEL_ER2_LCD_COMPARE)&&(keyModelNum != MODEL_OMV4_ER2_LCD)&&(keyModelNum != MODEL_OMV4_ER2_LCD_ECR)&&(keyModelNum != MODEL_OMV4_ER2_LCD_SATO))
	{
		error = 1;
	}
...
#endif//#ifdef KEY_DRV_OMV4_ER2_LCD
