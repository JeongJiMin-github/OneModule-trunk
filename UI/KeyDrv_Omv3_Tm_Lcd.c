...
{
	{
		KEY_HOLD, KEY_UNIT_CHANGE,	KEY_ZERO,  KEY_TARE, KEY_ZERO,  KEY_TARE
	},
	{
		KEY_HOLD, KEY_UNIT_CHANGE,	KEY_ZERO,  KEY_TARE, KEY_ZERO,  KEY_TARE
	},
...
{
    /*powerCheckRingBufPtr = (&AdDrvRingBufForAd6);
...
{  
	...
	else if (KEY_PORT_UNIT_CHANGE == 0)
	{
		keyDrvRawData = 4;
	}
	else
