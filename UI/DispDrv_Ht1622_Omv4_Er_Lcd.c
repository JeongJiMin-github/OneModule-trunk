...
* @file    DispDrv_Ht1622_Omv4_Er_Lcd.c
* @version 1.0
* @date    2016/12/06
...
#ifdef DISP_DRV_HT1622_M0516LDN_ER
/*
********************************************************************************
...
#define DISP_DRV_ADDR_ZERO			{30, 0x02}//6j weight
/** @brief NET indicator */
#define DISP_DRV_ADDR_NET				{30, 0x01}//5j weight
...
#define DISP_DRV_ADDR_KG				{28, 0x08}//4j weight
/** @brief 100g KEY indicator*/
#define DISP_DRV_ADDR_LB				{28, 0x04}//3j weight
/** @brief 100g KEY indicator*/
#define DISP_DRV_ADDR_TARESAVE		{28, 0x01}//1j weight
/** @brief Prepack indicator*/
#define DISP_DRV_ADDR_PREPACK			{12, 0x80}//4j unit price same EURO, alternate use
#ifdef USE_CTS_MODE
/** @brief CTS Delay indicator*/
#define DISP_DRV_ADDR_CTS_DELAY			{12, 0x10}
#endif
...
/** @brief 100g KEY indicator*/
#define DISP_DRV_ADDR_OZ				{28, 0x02}//2j weight
/** @brief 100g KEY indicator*/
...
/** @brief 100g KEY indicator*/
#define DISP_DRV_ADDR_BOTHSAVE		{12,0x08}//4j total price
/** @brief 100g KEY indicator*/
#define DISP_DRV_ADDR_OZ			{28, 0x02}//2j weight
/** @brief 100g KEY indicator*/
#define DISP_DRV_ADDR_UNITPRICE_KG	{12, 0x40}//3j unit price
...
#ifdef USE_CTS_MODE 
	{0, 0},								//34 Connected AC
	DISP_DRV_ADDR_CTS_DELAY				//35 CtsDelay
#else
	{0, 0}								//34 Connected AC
#endif
};
...
#endif//#ifdef DISP_DRV_HT1622_M0516LDN_ER
