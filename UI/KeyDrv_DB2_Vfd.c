...
{
	{
		KEY_ZERO,	KEY_TARE,	KEY_MODE,	KEY_SET,			KEY_SAMPLE,			KEY_HOLD,	KEY_PRINT,			KEY_ON_OFF
//		KEY_ZERO,	KEY_TARE,	KEY_MODE,	KEY_NOT_EXISTED,	KEY_NOT_EXISTED,	KEY_HOLD,	KEY_NOT_EXISTED,	KEY_ON_OFF					
	}																			  
};
...
{
//	KEY_ZERO,	KEY_NOT_EXISTED,	KEY_MODE,	KEY_TARE,	KEY_HOLD,	KEY_TARE, KEY_NOT_EXISTED, KEY_NOT_EXISTED, KEY_NOT_EXISTED
