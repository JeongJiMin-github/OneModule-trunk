...
#define DISP_DRV_ADDR_WEIGHT_MINUS		{20, 0x04}
/** @brief Stable indicator*/
#define DISP_DRV_ADDR_STABLE			{20, 0x01}
/** @brief NET indicator*/
#define DISP_DRV_ADDR_NET				{20, 0x08}
/** @brief Low Battery indicator*/
#define DISP_DRV_ADDR_LOW_BATT			{1, 0x08}
/** @brief Ounce indicator*/
#define DISP_DRV_ADDR_OZ				{0, 0x02}
/** @brief Pound indicator*/
#define DISP_DRV_ADDR_LB				{0, 0x01}
...
#define DISP_DRV_ADDR_PCS				{5, 0x01}
/** @brief Zero indicator*/
#define DISP_DRV_ADDR_ZERO				{20, 0x02}
/** @brief High indicator, for comparator*/
#define DISP_DRV_ADDR_HI				{21, 0x01}
/** @brief Low indicator, for comparator*/
#define DISP_DRV_ADDR_LOW				{21, 0x06}
/** @brief OK indicator, for comparator*/
#define DISP_DRV_ADDR_OK				{21, 0x0C}
/** @brief OK indicator, for counting*/
#define DISP_DRV_ADDR_LACK				{21, 0x0A}
/** @brief OK indicator, for counting*/
#define DISP_DRV_ADDR_FRAC_BAR			{3, 0x08}
/** @brief OK indicator, for counting*/
#define DISP_DRV_ADDR_FRAC_DENOM		{5, 0x04}
/** @brief OK indicator, for counting*/
#define DISP_DRV_ADDR_FRAC_NUMER		{5, 0x02}
...
{
	{18, 0x08}, {15, 0x08}, {12, 0x08}, {9, 0x08}, {6, 0x08}
};

/** @brief Comma addr and mask*/
const INDICATOR_ADDR code dispDrvCommaAddrTable[5] =
{
	{17, 0x08}, {14, 0x08}, {11, 0x08}, {8, 0x08}, {5, 0x08}
};

/** @brief s0~s39 중 디지트 시작 주소*/
//INT8U code dispDrvCharAddrTable[5] = { 18, 15, 12, 9, 6};
INT8U code dispDrvCharAddrTable[7] = { 18, 15, 12, 9, 6, 3, 1};
...
void DispDrvFillChar(char fillChar)
{
	...
	DispDrvSetChar(WIN_WEIGHT, 5, fillChar);
	DispDrvSetChar(WIN_WEIGHT, 6, fillChar);
}
...
#endif//#ifdef DISP_DRV_HT1621_SW_LB
