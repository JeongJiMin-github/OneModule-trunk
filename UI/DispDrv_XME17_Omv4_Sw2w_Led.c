...
* @file    DispDrv_XME17_Omv4_Sw2w_Led.c
* @version 1.0
* @date    2018/09/18
...
#ifdef DISP_DRV_XME17_OMV4_SW2W_LED
...
/* Insert #define here */
/** @brief Display 갯수*/
#define DISP_DRV_WIN_MAX_NUM	4

/** @brief Display driver buffer size*/
#define DISP_DRV_BUF_SIZE	9
...
#define DISP_DRV_ADDR_STABLE			        {7, 0x02}
/** @brief NET indicator*/
#define DISP_DRV_ADDR_NET				{7, 0x01}
/** @brief Low Battery indicator*/
#define DISP_DRV_ADDR_LOW_BATT		                {7, 0x08}
/** @brief Zero indicator*/
#define DISP_DRV_ADDR_ZERO			        {7, 0x04}

/** @brief Kilo gram Indicator */
#define DISP_DRV_ADDR_KG				{8, 0x02}
/** @brief Pound Indicator */
#define DISP_DRV_ADDR_LB				{8, 0x04}
/** @brief Ounce Indicator */
#define DISP_DRV_ADDR_OZ				{8, 0x08}
/** @brief Gram Indicator */
#define DISP_DRV_ADDR_GRAM			        {8, 0x01}

/** @brief High indicator, for comparator*/
#define DISP_DRV_ADDR_HI				{9, 0x20}
/** @brief Low indicator, for comparator*/
#define DISP_DRV_ADDR_LOW				{9, 0x04}
/** @brief OK indicator, for comparator*/
#define DISP_DRV_ADDR_OK                                {9, 0x10}
/** @brief OK indicator, for counting*/
#define DISP_DRV_ADDR_LACK				{9, 0x01}

/** @brief PCS indicator, for counting*/
#define DISP_DRV_ADDR_PCS				{9, 0x02}//=DISP_DRV_ADDR_GRAM
...
void DispDrvProcForInterrupt(void)
{
    ...
    //dispXme17(digitCount,LED_SEG_DATA);
...
#endif//#ifdef DISP_DRV_XME17_OMV4_SW2W_LED
