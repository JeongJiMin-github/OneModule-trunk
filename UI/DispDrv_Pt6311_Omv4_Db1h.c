...
#ifdef DISP_DRV_PT6311_OMV4_DB1H_VFD
/*
********************************************************************************
...
#define DISP_DRV_BUF_SIZE	14
/** @brief Display driver module size*/
#define DSP_DRV_MODULE_SIZE	7
...
#define DISP_DRV_ADDR_STABLE				{0, 0}
/** @brief NET indicator*/
#define DISP_DRV_ADDR_NET					{0, 0x08}
...
#define DISP_DRV_ADDR_PCS					{0, 0}
/** @brief Zero indicator*/
#define DISP_DRV_ADDR_ZERO				{0, 0x01}
/** @brief High indicator, for comparator*/
#define DISP_DRV_ADDR_HI					{0, 0}
/** @brief Low indicator, for comparator*/
#define DISP_DRV_ADDR_LOW					{0, 0}
/** @brief OK indicator, for comparator*/
#define DISP_DRV_ADDR_OK					{0, 0}

/** @brief VFD ON Command*/
#define DISP_DRV_COMMAND_ON     		0x08
/** @brief VFD OFF Command*/
...
{
	{2, 0x80}, {4, 0x80}, {6, 0x80}, {8, 0x80}, {10, 0x80}, {12, 0x80} 
};

/** @brief Comma addr and mask*/
const INDICATOR_ADDR code dispDrvCommaAddrTable[6] =
{
	{3, 0x01}, {5, 0x01}, {7, 0x01}, {9, 0x01}, {11, 0x01}, {13, 0x01} 
};

/** @brief s0~s39 중 디지트 시작 주소*/
INT8U code dispDrvCharAddrTable[6] = {2, 4, 6, 8, 10, 12};
...
********************************************************************************
*/
void pt6311WriteCommand(INT8U Data)	// Local Command
{     
	VFD_STRB = 0;
	delay2Clock();
