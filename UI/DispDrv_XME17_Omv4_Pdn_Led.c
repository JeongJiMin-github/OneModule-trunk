...
* @file    DispDrv_XME17_Omv4_PDN.c
* @version 1.0
* @date    2020/04/17
* @author  Yang Seon Woong (chamchida)
********************************************************************************
...
#ifdef DISP_DRV_XME17_OMV4_PDN_LED
...
#define DISP_DRV_ADDR_STABLE			{9, 0x01}
/** @brief NET indicator*/
#define DISP_DRV_ADDR_NET				{9, 0x04}
/** @brief Zero indicator*/
#define DISP_DRV_ADDR_ZERO			    {9, 0x02}


/** @brief Kilo gram Indicator */
#define DISP_DRV_ADDR_KG				{9, 0x08}
/** @brief Pound Indicator */
#define DISP_DRV_ADDR_LB				{9, 0x10}
/** @brief Ounce Indicator */
#define DISP_DRV_ADDR_OZ				{9, 0x20}
/** @brief Gram Indicator */
#ifdef COUNTRY_UNITEDSTATES
#define DISP_DRV_ADDR_GRAM		        {9, 0x08}
#else
#define DISP_DRV_ADDR_GRAM		        {9, 0x20}
#endif
/** @brief High indicator, for comparator*/
#define DISP_DRV_ADDR_HI				{8, 0x02}
/** @brief Low indicator, for comparator*/
#define DISP_DRV_ADDR_LOW				{8, 0x01}
/** @brief OK indicator, for comparator*/
#define DISP_DRV_ADDR_OK				{8, 0x04}
...
/** @brief TRIANGLE_MASK*/
#define DISP_DIGIT_1			0x60//1
/** @brief TRIANGLE_MASK*/
#define DISP_DIGIT_2			0x62//2
/** @brief TRIANGLE_MASK*/
#define DISP_DIGIT_3			0x64//3
/** @brief TRIANGLE_MASK*/
#define DISP_DIGIT_4			0x66//4
/** @brief TRIANGLE_MASK*/
#define DISP_DIGIT_5			0x68//5
/** @brief TRIANGLE_MASK*/
#define DISP_DIGIT_6			0x6A//6
/** @brief TRIANGLE_MASK*/
#define DISP_DIGIT_7			0x6C//7
/** @brief TRIANGLE_MASK*/
#define DISP_DIGIT_8			0x6E//8
/** @brief TRIANGLE_MASK*/
#define DISP_DIGIT_9			0x70//9
...
void ledClear(void);
void xme17Start(void);
void xme17End(void);
void xme17Ack(void);
void xme17Add(INT8U csadd);
void xme17Data(INT8U csdata);
void dispXme17(INT8U csadd, INT8U csdata);
void dispXme17OnOff(INT8U onOff);
...
*/
#ifdef COUNTRY_UNITEDSTATES // CAL6 U -> P -> S 순서
...
{
      {1, 0x80}, {2, 0x80}, {3, 0x80}, {4, 0x80}, {5, 0x80}, {6, 0x80}
};

const INDICATOR_ADDR code dispDrvCommaAddrTable[6] =          // duckspg led dp 변경 
{
...
//	INT8U mask;
	...
	for (i = 0; i < dataSize; i++) 
	{
		...
		addr = dispDrvCharAddrTable[i] + winNum * 9;
...
void DispDrvProc(void)
{
    ...
    if(dispDrvTurnOnOff)
	{
		for (i = DISP_OFFSET,j=1; i <= (DISP_OFFSET + (DISP_DRV_BUF_SIZE<<1)) ; i=i+2)
		{
						dispXme17OnOff(ON);
                        dispXme17(i,dispDrvBuf[dispTransPage][j]);
                        j++;
		}
	}
	else
...
void dispDrvSetDot(INT8U winNum, INT8U decPos, INT8U on)
{
	...
	{
		dispDrvBuf[dispEditingPage][addr] = dispDrvBuf[dispEditingPage][addr] 
                  & (~mask);
	}
}
...
*           
* @return   none
* @remark   dig의 주소를 xme17에 보내주는 함수 
********************************************************************************
*/
...
/**
********************************************************************************
* @brief    xme17의 data 함수 
* @param    csdata : 각 dig 의 숫자 값을 입력 한다.  
*           
*           
* @return   none
* @remark   dig의 값을  xme17에 보내주는 함수 
********************************************************************************
*/
...
*           
* @return   none
* @remark   xme17을 통해서 특정 dig 주소에 특정 숫자 값을 입력하는 함수  
********************************************************************************
*/
...
void dispXme17OnOff(INT8U onOff)
{
    dispXme17(0x48,onOff);      // LED power on 
}
...
#endif//#ifdef DISP_DRV_XME17_OMV4_PDN
